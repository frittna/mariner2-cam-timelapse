...
export default function Files() {
  ...
  return (
    <div className="container pt-2 pb-2">
      <div className="mb-2 flex flex-wrap items-center justify-between w-full">
        <div>
  ...
  <div className="cam-control-bar" style={{
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: '#aaa', fontWeight: 'bold' }}>
      ...
      <span id="files-text">{camSize === 'HIDE' ? 'CAM: OFF' : 'CAM: ON'}</span>
    </div>
          ...
          <div className="divide-y">
            ...
            {data?.directories.map((dir: DirectoryEntry) => (
              ...
              >
                ...
                >
                  <Folder className="h-4 w-4 text-primary break-words" />
                  <span className="font-medium" title={dir.dirname}>{ellipsizeMiddle(dir.dirname, 128)}</span>
                </button>
                <button
                  type="button"
            ...
            {data?.files.map((file: FileEntry) => (
              ...
              >
                ...
                <span className="min-w-0 flex-1 font-mono text-sm break-words" title={file.filename}>
                  {ellipsizeMiddle(file.filename, 128)}
                </span>
